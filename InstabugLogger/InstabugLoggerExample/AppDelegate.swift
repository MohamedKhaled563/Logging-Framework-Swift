...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        // Send the Main context and background context to the framework
        instabugLogger.configure(mainContext: persistentContainer.viewContext, backgroundContext: backgroundContext)
        instabugLogger.deleteAllLogs()
        return true
    }
